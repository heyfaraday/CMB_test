...
map_I = hp.read_map('data/COM_CMB_IQU-smica_1024_R2.02_full.fits', field=2)

alm_I = hp.sphtfunc.map2alm(map_I, lmax=lmax)

hp.fitsfunc.write_alm('planck_2_dir/planck_2_U_64.fits', alm_I)
file_map = open('planck_2_dir/planck_2_U_norm_64.dat', 'w')

alms_from_file = hp.fitsfunc.read_alm('planck_2_dir/planck_2_U_64.fits')

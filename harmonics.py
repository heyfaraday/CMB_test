...
alm_I = hp.sphtfunc.map2alm(map_I, lmax=512)

hp.fitsfunc.write_alm('planck_2_I.fits', alm_I)
file_map = open('planck_2_dir/planck_2_I_norm.dat', 'w')

alms_from_file = hp.fitsfunc.read_alm('planck_2_I.fits')

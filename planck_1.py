...
surf = open('planck_1_dir/surf.dat', 'w')
le = open('planck_1_dir/len.dat', 'w')
nmax = open('planck_1_dir/max.dat', 'w')
nmin = open('planck_1_dir/min.dat', 'w')
nsad = open('planck_1_dir/sad.dat', 'w')
points = open('planck_1_dir/points.dat', 'w')
...
a_from_file = healpy_format.healpy_alm('alm.fits', 256)

...
Ux, Uy, Uxx, Uyy, Uxy = genfromtxt('../data_map_f/derivatives1.dat').T
Qx, Qy, Qxx, Qyy, Qxy = genfromtxt('../data_map_f/derivatives2.dat').T
...
def cubic (Qx, Qy, Ux, Uy):
    ...
    if (det > 0):
        a = roots([a, b, c, d])
        a = a.real
        a = [atan(a[0])*180/pi, atan(a[1])*180/pi, atan(a[2])*180/pi]

         ...
         dimension dens(0:500,0:500),dfs(0:500,0:500),dfss(0:500,0:500)
            ...
            open(unit=10,file='../data_map_f/f.dat')
            open(unit=11,file='../data_map_f/derivatives.dat')
            open(unit=12,file='../data_map_f/skf.dat')
            
          print 1000
 1000     format('number of points :',',' )
          read *, NN
          print 1001
 1001     format('contour line height :')
          read *, mys
...
c---------------extrema-----------------------------
              ...
              dll=0.d0
               ...
               open(unit=11,file='max.dat')
               open(unit=12,file='min.dat')
               open(unit=13,file='sad.dat')
               open(unit=14,file='skelet.dat')
